...
void slow_servo_lower(int position);#include <kipr/botball.h>
...
//FIREPOLE
    ...
    rotate_claw(1500);
     ...
     //SAVE THOSE HECKING PEOPLE!!!
    reset_megatron();
    drive_forward(30);
    rotate_claw(1048);
    lift_and_lower_claw(0);
    open_and_close_claw(772);
    drive_forward(20);
    open_and_close_claw(1200);
    drive_back(10);
    turn_left(180);
    drive_forward(30);
    lift_and_lower_claw(200);
    open_and_close_claw(100);
    reset_megatron();
    return 0;
}
void drive_forward(int distance)
